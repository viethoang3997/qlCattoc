				...
				<div class="col-md-9">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" name="id" class="form-control" value="<?php echo e($SanPham ->id); ?>" readonly="readonly">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Tên sản phẩm *</label>
							<input type="text" name="title" class="form-control" value="<?php echo e($SanPham ->title); ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Giá *</label>
							<input type="text" name="price" class="form-control" value="<?php echo e($SanPham ->price); ?>" >
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label>Giới thiệu</label>
							<textarea id="demo" class="form-control ckeditor" rows="5" name="introduce" ><?php echo e($SanPham ->introduce); ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label>Thông tin chi tiết</label>
							<textarea id="demo" class="form-control ckeditor" rows="5" name="details" ><?php echo e($SanPham ->details); ?></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label>Hướng dẫn sử dụng</label>
							<textarea id="demo" class="form-control ckeditor" rows="5" name="guide" ><?php echo e($SanPham ->guide); ?></textarea>
						</div>
					</div>
				</div>
					...
					<div class="add--img">
						...
						<div class="form-group form--img">
							...
							<button class="browse btn btn-img" type="button">
								<img src="upload/images/<?php echo e($SanPham ->images); ?>" width="150px" height="150px">
							</button>
						</div>

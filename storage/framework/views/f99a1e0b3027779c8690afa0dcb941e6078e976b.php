   ...
   <div class="wrapper row"> 
    <div class="preview col-md-6"> 
     <div class="preview-pic tab-content"> 
      <div class="tab-pane active" id="pic-1"><img src="upload/images/<?php echo $SanPham ->images; ?>" alt="">
      </div> 
    ...
    <div class="details col-md-6"> 
     <h3 class="product-title"><?php echo $SanPham ->title; ?></h3> 
     <div class="rating"> 
     ...
     <p class="product-description"><?php echo $SanPham ->introduce; ?></p> 
     <h4 class="price"><?php echo $SanPham ->price; ?></h4> 

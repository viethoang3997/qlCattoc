				...
				<div class="row">
					<div class="col-md-5">
					    ...
					    <table class="table table-bordered table-responsive" id="table1">
					        ...
					        <tbody>
					        <?php $__currentLoopData = $NhanVien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a => $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					        <tr>
					            <td><?php echo e($key -> id); ?></td>
					            <td>
					               <?php echo e($key -> fullName); ?>

					            </td>
					            <td><?php echo e($key->birthday); ?></td>
					            <td data="<?php echo e($key -> fullName); ?>">

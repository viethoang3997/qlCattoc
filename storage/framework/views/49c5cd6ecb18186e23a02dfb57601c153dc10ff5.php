				...
				<div class="col-md-9">
					<div class="col-md-12">
						<div class=" form-group">
							...
							<input type="text" name="id" class="form-control" value="<?php echo e($DichVu->id); ?>" readonly="readonly">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Tên dịch vụ *</label>
							<input type="text" name="title" class="form-control" value="<?php echo e($DichVu->title); ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Giá</label>
							<input type="text" name="price" class="form-control" value="<?php echo e($DichVu->price); ?>">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Nội dung</label> 
							<textarea id="demo" class="form-control ckeditor" rows="5" name="content" ><?php echo e($DichVu -> content); ?></textarea>
						</div>
					</div>
				</div>
					...
					<div class="add--img">
						...
						<div class="form-group form--img">
							...
							<button class="browse btn btn-img" type="button">
								<img src="upload/images/<?php echo e($DichVu ->images); ?>" width="150px" height="150px">
							</button>
						</div>

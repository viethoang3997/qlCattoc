...
<body>
	...
	<div class="container" style="width: 90%">
		...
		<form action="admin/NhanVien/Sua/<?php echo e($NhanVien->id); ?>" method="POST" id="upload" enctype="multipart/form-data">
				...
				<div class="col-sm-9">
					<div class="col-sm-12">
						<div class="form-group">
							<label>Mã</label>
							<input type="text" name="id" class="form-control" value="<?php echo e($NhanVien->id); ?>" readonly="readonly">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label>Họ Tên *</label>
							<input type="text" name="fullName" class="form-control" value="<?php echo e($NhanVien->fullName); ?>">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="input_text form-control" name="gender">
				                ...
				                <option value="1" <?php echo e($NhanVien->gender == 1 ? 'selected' : ''); ?>>Nam</option>
				                <option value="2" <?php echo e($NhanVien->gender == 2 ? 'selected' : ''); ?>>Nữ</option>
			                </select>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="date" name="birthday" class="form-control" value="<?php echo e($NhanVien->birthday); ?>">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label>Quê quán</label>
							<input type="text" name="address" class="form-control" value="<?php echo e($NhanVien->address); ?>">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label>Số điện thoại</label>
							<input type="text" name="phone" class="form-control" value="<?php echo e($NhanVien->phone); ?>">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea id="demo" class="form-control ckeditor" rows="5" name="experience" ><?php echo e($NhanVien -> experience); ?></textarea>
						</div>
					</div>
				</div>
					...
					<div class="add--img">
						...
						<div class="form-group form--img">
							...
							<button class="browse btn btn-img" type="button">
								<img src="upload/images/<?php echo e($NhanVien ->images); ?>" width="150px" height="150px">
							</button>
						</div>

...
<body>
	...
	<div class="container" style="width: 90%">
		<span style="text-align: center;"><h3>Thêm sản phẩm</h3></span>
				...
				<div class="col-md-9">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="title" class="form-control" placeholder="Điền tên sản phẩm">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Giá *</label>
							<input type="text" name="price" class="form-control" placeholder="Điền giá sản phẩm">
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label>Giới thiệu</label>
							<textarea id="demo" class="form-control ckeditor" rows="5" name="introduce" ></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label>Thông tin chi tiết</label>
							<textarea id="demo" class="form-control ckeditor" rows="5" name="details" ></textarea>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
							<label>Hướng dẫn sử dụng</label>
							<textarea id="demo" class="form-control ckeditor" rows="5" name="guide" ></textarea>
						</div>
					</div>
				</div>

			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						<label>Mã</label>
						<input type="text" name="id" class="form-control" value="<?php echo e($ThoiGian->id); ?>" readonly="readonly">
					</div>
					<div class="form-group">
						<label>Thời gian *</label>
						<input type="text" name="title" class="form-control" value="<?php echo e($ThoiGian->title); ?>">
					</div>
				</div>
			</div>
